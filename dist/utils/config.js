...
import { z } from 'zod';
import { getAgentConfigPath, findConfigFile, getMCPBoxConfigDir, getBackupDir, ensureDir, pathExists, createSafeFilename } from './paths.js';
...
export class MCPBoxConfigManager {
    configPath;
    config = null;
    constructor() {
     ...
     */
    async loadAgentConfig(agent, scope = 'user') {
     ...
     */
    async saveAgentConfig(agent, config, scope = 'user') {
     ...
     */
    async mergeAgentConfig(agent, newConfig, scope = 'user') {
        try {
            let existingConfig = {};
            try {
     ...
     */
    async createBackup(agent, scope = 'user') {
